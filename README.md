...
## Javascript Assignments  [![Build Status](https://travis-ci.org/EugeneIvankin/js-assignments.svg?branch=master)](https://travis-ci.org/EugeneIvankin/js-assignments-1)
